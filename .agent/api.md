...
| 14 | 1 B | `navCursor` | メニューカーソル位置 |
| 15 | 1 B | `targetBpm` | ゲーム目標テンポ（生 BPM） |
| 16 | 1 B | `score` | 0–100 / 0xFF=未確定 |
...
「内容が変化したとき＋最大 5Hz の保険送出」に絞り、NOTE バーストを阻害しない。Processing は
