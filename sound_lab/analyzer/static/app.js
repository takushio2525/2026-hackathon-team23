...
(function () {
  ...
  function setMode(mode) {
    ...
    $("#balanceModeBtn").classList.toggle("active", !single);
    $("#singleModeBtn").setAttribute("aria-selected", single ? "true" : "false");
    $("#balanceModeBtn").setAttribute("aria-selected", single ? "false" : "true");
  }
