...
第2回議事録（[`../23_第2回議事録_24G1075.pdf`](../23_第2回議事録_24G1075.pdf)）の
**表1 WBS（作業分担表）** を、授業資料の正解形式（時間的フェーズ＝開発工程軸）
で再構成した版を、**1 つの表**として提示する。

[`../../../work/shiozawa/work-0422/wbs_proposal/main.pdf`](../../../work/shiozawa/work-0422/wbs_proposal/main.pdf)
第4章「新 WBS（提案版）」と内容は同じだが、こちらは GitHub 上で
1 つのスクロール可能な表として一覧したい用途。
...
- 議事録 表1 ↔ 本表 の対応関係（議事録 17 行のうち何が新 WBS のどこに移ったか）
  は [`../../../work/shiozawa/work-0422/wbs_proposal/main.pdf`](../../../work/shiozawa/work-0422/wbs_proposal/main.pdf)
  第 5 章を参照。

## 同フォルダの関連ファイル

- [`design_assignments.md`](design_assignments.md) — 今週の課題用：
  **110 基本設計 と 120 詳細設計** から 111〜113（チーム合意形成タスク）を
  除いた 9 タスクの担当者割振りだけを抜粋した共有用ファイル。
...
[`../../../work/shiozawa/work-0422/wbs_proposal/`](../../../work/shiozawa/work-0422/wbs_proposal/)
と同じく**チーム内議論用**。計画書本体（[`../../../work/shiozawa/work-0422/提出用計画書/plan_template.tex`](../../../work/shiozawa/work-0422/提出用計画書/plan_template.tex)）
