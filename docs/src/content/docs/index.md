...
description: 指揮者 1 ＋ 楽器 4 ＋ PC で輪唱を奏でる、5 台同期演奏システムの解説サイト
template: splash
hero:
...
工学院大学・2026 年ハッカソン課題のチーム 23 が作る **Arduino オーケストラ** の
公式解説サイトです。**Git や PlatformIO に初めて触れる読者** でも単独で全体像を
追えるよう、用語・図・コード解説を一通り揃えました。

- **聴衆 / 審査員の方** は、まず [プロジェクト概要](/intro/overview/) と
  [なぜ作るのか](/concept/why/) を読むと全体像が掴めます。
