...
- 目的: 指揮者の IMU ジェスチャを起点に、楽器ノード 3〜4 台と PC 音色合成を UDP で同期させる
  （test_v2 は 3 台で輪唱を実装済み、production 想定は 4 台）
...
- ターゲット:
  ...
  - 楽器 `node_02〜05`: **Arduino UNO R4 WiFi**
