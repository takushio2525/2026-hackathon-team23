...
支える単純なリズム伴奏です。8拍ごとの区切りではスネアとハイハットを少し強め、
主旋律が3声そろう16〜31拍目は全体のベロシティを少し上げます。
終止前の36〜38拍目はハイハットを弱め、38拍目に半拍遅れのスネアを入れて
終わりに向かう流れを作ります。最後の39拍目にはキックとクラッシュシンバルを
重ね、40拍目でホルンとチューバと同時に終わります。
