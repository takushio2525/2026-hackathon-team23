...
\begin{itemize}
  ...
  \item 主要成果：
    \begin{itemize}
      ...
      \item {}ドラム音色についても，キック，スネア，ハイハット，
        クラッシュシンバルの音源分析と音色データ作成を行った．
    \end{itemize}
  \item 重大課題（影響度：高）：
    \begin{itemize}
      \item {}ドラム音色の分析と作成は完了したが，
        Processing上で自然に聞こえるようにするための音量，
        余韻，終わり方の微調整は完了していない．
    \end{itemize}
\end{itemize}
...
課題曲の演奏楽器の分析・作成
  & 6/3 & 6/10 & 未完了 & 90\%
  & なし
  & 金管楽器とドラムの音色分析・作成は完了し，ドラム音色の微調整を継続中． \\
\bottomrule
\end{tabularx}
}
...
Arduino側への反映・実機確認の未実施
  ...
  & 統合作業時 & 未対応 \\
ドラム音色の微調整未完了
  & キック，スネア，ハイハット，クラッシュシンバルの音色分析と作成は完了したが，
    曲中で自然に聞こえる音量，余韻，終わり方の調整が残っている．
  & 中 & 高
  & Processing上で金管パートと同時に再生し，ドラム音色の音量バランスと減衰の不自然さを確認しながら調整する．
  & 次回作業時 & 対応中 \\
\bottomrule
\end{tabularx}
}
...
\begin{itemize}
  \item 目標：
    \begin{itemize}
      \item {}Processingスケッチを用いて作成したドラム音色を試聴し，
        音量，余韻，終わり方を微調整する．
