...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{Figs/GC_week6.png}
  \caption{担当箇所のGC（現在）}
...
\begin{itemize}
  ...
  \item 参照資料：
    \begin{itemize}
      \item {}\texttt{work/saito/week5/kaeru\_score\_debug/kaeru\_score\_debug.pde}
      \item {}\texttt{work/saito/week5/kaeru\_score\_debug/README.md}
      \item {}\texttt{work/saito/week6/作業ログ/Figs/GC\_week6.png}
      \item {}\texttt{work/saito/week6/作業ログ/作業ログ\_25G1053.tex}
    \end{itemize}
  \item 検証手順：
    \begin{enumerate}
      ...
      \item {}課題管理では，Processing確認済みの内容を未対応課題に残さず，
        Arduino側への反映・実機確認のみを残した．
    \end{enumerate}
\end{itemize}
