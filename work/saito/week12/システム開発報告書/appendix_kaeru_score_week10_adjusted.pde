...
final PartDefinition[] MELODY_PARTS = {
  new PartDefinition("主旋律1 / フルート",     "flute.tweaked.instrument.json",     0,  12, 0.28f),
  new PartDefinition("主旋律2 / トランペット", "trumpets.tweaked.instrument.json",  8,  12, 0.22f),
  new PartDefinition("主旋律3 / トロンボーン", "trombones.tweaked.instrument.json", 16, -12, 0.22f),
  new PartDefinition("主旋律4 / オルガン",     "organ.tweaked.instrument.json",     24, -12, 0.25f)
};
