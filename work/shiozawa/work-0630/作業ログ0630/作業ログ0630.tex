...
\begin{itemize}
  ...
  \item 重大課題（影響度：低）：
    \begin{itemize}
      \item {}[発表会前日（7/1）のため，残りはデモ構成の最終調整のみ]
    \end{itemize}
\end{itemize}
...
作業項目（フェーズ）
 ...
 & \cellcolor{barPlan}\tiny 6/17 & \cellcolor{barPlan}\tiny 6/24 & \cellcolor{nowCol}\tiny\textcolor{white}{7/1} \\
\midrule
企画・テーマ決定        & \bD & \bD &     &     &     &     &     &     &     &     &     &     \\
110 基本設計            &     &     & \bD & \bD &     &     &     &     &     &     &     &     \\
120 詳細設計            &     &     &     &     & \bD &     &     &     &     &     &     &     \\
...
評価（MOE/MOP 検証プログラム）の基盤も整備完了．明日の発表会に向けた最終調整段階．
