...
\node[small, above right=8mm and 13mm of wifi] (n1) {node\_01\\トランペット};
\node[small, above right=1mm and 13mm of wifi] (n2) {node\_02\\ホルン};
\node[small, below right=6mm and 13mm of wifi] (n3) {node\_03\\トロンボーン};
\node[small, below=13mm of n3] (n4) {node\_04\\チューバ};
...
\node[proc, below left=8mm and 19mm of rest] (note) {発音情報生成\\durationMs計算};
\node[proc, below right=8mm and 19mm of rest] (skip) {NOTE送信なし\\拍だけ進行};
\node[proc, below=22mm of rest] (off) {instrumentId付与\\音色を指定};
