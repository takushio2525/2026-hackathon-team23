...
const ScoreEvent kScore[] = {
    ...
    { 1, 64, 100, 240, 0x01 },  // ミ E4
    { 2, 65, 100, 240, 0x01 },  // ファ F4
    { 3, 67, 100, 240, 0x01 },  // ソ G4
    { 4, 69, 100, 240, 0x01 },  // ラ A4
    { 5, 67, 100, 240, 0x01 },  // ソ G4
    { 6, 65, 100, 240, 0x01 },  // ファ F4
    { 7, 64, 100, 480, 0x01 },  // ミ E4 (約 2 拍)
};
