...
const ScoreEvent kScore[] = {
    ...
    { 1, 60, 100, 240, 0x01 },  // ド C4
    { 2, 62, 100, 240, 0x01 },  // レ D4
    { 3, 64, 100, 240, 0x01 },  // ミ E4
    { 4, 65, 100, 240, 0x01 },  // ファ F4
    { 5, 64, 100, 240, 0x01 },  // ミ E4
    { 6, 62, 100, 240, 0x01 },  // レ D4
    { 7, 60, 100, 480, 0x01 },  // ド C4 (約 2 拍)
};
