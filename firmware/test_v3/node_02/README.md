...
```bash
pio run -d firmware/test_v3/node_02                  # ビルド
pio run -d firmware/test_v3/node_02 -t upload        # 書き込み
pio device monitor -d firmware/test_v3/node_02       # 注: Processing と同時に開けない (ポート競合)
```
