...
```bash
pio run -d firmware/test_v3/node_04                  # ビルド
pio run -d firmware/test_v3/node_04 -t upload        # 書き込み
pio device monitor -d firmware/test_v3/node_04       # 注: Processing と同時に開けない (ポート競合)
```
