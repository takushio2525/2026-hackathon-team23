...
const ScoreEvent kScore[] = {
    ...
    { 17, 60, 100, 128, 0x01, 0, 0, 0, 0 },  // グワッ C4 (短い 4 分)
    { 18,  0,   0,   0, 0x04, 0, 0, 0, 0 },  //       (休符)
    { 19, 60, 100, 128, 0x01, 0, 0, 0, 0 },  // グワッ C4
    { 20,  0,   0,   0, 0x04, 0, 0, 0, 0 },  //       (休符)
    { 21, 60, 100, 128, 0x01, 0, 0, 0, 0 },  // グワッ C4
    { 22,  0,   0,   0, 0x04, 0, 0, 0, 0 },  //       (休符)
    { 23, 60, 100, 128, 0x01, 0, 0, 0, 0 },  // グワッ C4
    { 24,  0,   0,   0, 0x04, 0, 0, 0, 0 },  //       (休符)
    // フレーズ 4 (拍 25-32): ドドレレミミファファ ミ レ ドー
    // (「ゲロゲロゲロゲロ グワッグワッグワッ」)
    // 8 分音符ペア (上行): C4C4 D4D4 E4E4 F4F4 → 下行: E4 D4 C4ー
    { 25, 60, 100, 128, 0x01, 60, 100, 128, 128 },  // ドド C4×2 (8分)
    { 26, 62, 100, 128, 0x01, 62, 100, 128, 128 },  // レレ D4×2 (8分)
    { 27, 64, 100, 128, 0x01, 64, 100, 128, 128 },  // ミミ E4×2 (8分)
    { 28, 65, 100, 128, 0x01, 65, 100, 128, 128 },  // ファファ F4×2 (8分)
    { 29, 64, 100, 240, 0x01,  0,   0,   0,   0 },  // ミ  E4 (4分)
    { 30, 62, 100, 240, 0x01,  0,   0,   0,   0 },  // レ  D4 (4分)
