...
//   pio run -d firmware/test_v1/node_03
//   pio run -d firmware/test_v1/node_03 -t upload
//   pio device monitor -d firmware/test_v1/node_03
//
// 楽器ノード node_03 のエントリポイント (Arduino UNO R4 WiFi)
...
void setup() {
    ...
    DBG_WAIT_HOST(1500);
    DBG_PRINTLN("");
    DBG_PRINTLN("=== node_03 (performer partId=0x03) boot ===");
