...
//   pio run -d firmware/test_v1/node_04
//   pio run -d firmware/test_v1/node_04 -t upload
//   pio device monitor -d firmware/test_v1/node_04
//
// 楽器ノード node_04 のエントリポイント (Arduino UNO R4 WiFi)
...
void setup() {
    ...
    DBG_WAIT_HOST(1500);
    DBG_PRINTLN("");
    DBG_PRINTLN("=== node_04 (performer partId=0x04) boot ===");
